...
class DigiPayGateway extends AbstractGateway
{
    protected string $gateway = 'digipay';
    ...
    /**
     * Build DigiPay create-payment payload.
     *
     * IMPORTANT:
     * Field names must match the real DigiPay Merchant API.
     */
    protected function buildCreatePayload(
        ...
        return [
             ...
             * instead of recalculating it from the Order.
             */
            'amount' =>
                (int) round(

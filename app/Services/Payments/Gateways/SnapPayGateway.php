...
class SnapPayGateway extends AbstractGateway
{
    protected string $gateway = 'snappay';
    ...
    /**
     * Build SnapPay create-payment payload.
     *
     * IMPORTANT:
     * Field names must match the real SnapPay Merchant API.
     */
